...
from app.services.membership_service import get_or_create_gym
...
def gym_settings(
    ...
    return templates.TemplateResponse(request=request, name="gym_settings.html", context={"gym": gym})
...
def update_gym_settings(
    ...
    db.commit()
    return RedirectResponse(url="/gym-settings", status_code=303)
